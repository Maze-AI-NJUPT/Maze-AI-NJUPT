...
void MainWindow::initialControlWidget()
{
  ...
  //  sp_bs=new QSpinBox(this);
   ...
   // gLayout_Control->addWidget(sp_bs,2,1);
//    gLayout_Control->addWidget(label_blank[3],2,0,1,4);
...
void MainWindow::initialFightWin()
{
    ...
    Character_hpText->setText("体力");
    Character_atkText->setText("攻击");
    Character_defText->setText("防御");
