    ...
    QWidget(parent)
{
    ...
    button_Quit->setGeometry(360,325,120,30);
    ...
    button_About->setGeometry(360,365,120,30);
...
void interface::paintEvent(QPaintEvent*)
{
    ...
    if(!isok)
    {
        ...
        QImage pixmap(":/interface/image/interface/beijing1.PNG");//开始页
...
void interface::AboutShow()
{
    QMessageBox message(QMessageBox::Information,"关于",
                        "程序设计周：王晨宇、吴怡林、史孟德",QMessageBox::Yes,this);
